"""CLI: train the movement-phase classifier (top/bottom/hold/transition).

Same shape as the exercise classifier; phase labels come from the windowed sequence.
RandomForest baseline locally, sequence model (LSTM/GRU/TCN) on Colab.
"""
...
def main(argv=None) -> int:
    p = argparse.ArgumentParser(description="Train movement-phase classifier.")
    ...
    print(f"trained {args.model} phase classifier -> {args.run_dir}")
    return 0
